...
import io.ipgeolocation.sdk.invoker.auth.Authentication;
import io.ipgeolocation.sdk.invoker.auth.HttpBasicAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.ipgeolocation.io/v2";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.ipgeolocation.io/v2",
      "Test server",
    ...
    private void init() {
        ...
        setUserAgent("IPGeolocation/2.0.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ipgeolocation.io/v2
