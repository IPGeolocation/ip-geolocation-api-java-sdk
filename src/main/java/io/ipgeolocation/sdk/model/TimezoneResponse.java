...
public class TimezoneResponse {
  ...
  public TimezoneResponse ip(@javax.annotation.Nullable String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public TimezoneResponse airportDetails(@javax.annotation.Nullable TimezoneAirport airportDetails) {
  ...
  public TimezoneResponse loCodeDetails(@javax.annotation.Nullable TimezoneLocode loCodeDetails) {
  ...
  public TimezoneResponse location(@javax.annotation.Nullable TimezoneLocation location) {
  ...
  public TimezoneResponse timeZone(@javax.annotation.Nullable TimezoneDetails timeZone) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ip, timeZoneResponse.ip) &&
        Objects.equals(this.airportDetails, timeZoneResponse.airportDetails) &&
        Objects.equals(this.loCodeDetails, timeZoneResponse.loCodeDetails) &&
        Objects.equals(this.location, timeZoneResponse.location) &&
        Objects.equals(this.timeZone, timeZoneResponse.timeZone);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeZoneDetailedResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimezoneResponse.ipGeoRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeZoneDetailedResponse is not found in the empty JSON string", TimezoneResponse.ipGeoRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimezoneResponse.ipGeoFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeZoneDetailedResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimezoneResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeZoneDetailedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimezoneResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimezoneResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TimezoneResponse>() {
           @Override
           public void write(JsonWriter out, TimezoneResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimezoneResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeZoneDetailedResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeZoneDetailedResponse
   * @throws IOException if the JSON string is invalid with respect to TimeZoneDetailedResponse
   */
  public static TimezoneResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimezoneResponse.class);
  }

  /**
   * Convert an instance of TimeZoneDetailedResponse to an JSON string
   *
   * @return JSON string
   */
