...
public class AstronomyLocation {
  ...
  public AstronomyLocation locationString(@javax.annotation.Nullable String locationString) {
  ...
  public AstronomyLocation continentCode(@javax.annotation.Nullable String continentCode) {
  ...
  public AstronomyLocation continentName(@javax.annotation.Nullable String continentName) {
  ...
  public AstronomyLocation countryCode2(@javax.annotation.Nullable String countryCode2) {
  ...
  public AstronomyLocation countryCode3(@javax.annotation.Nullable String countryCode3) {
  ...
  public AstronomyLocation countryName(@javax.annotation.Nullable String countryName) {
  ...
  public AstronomyLocation countryNameOfficial(@javax.annotation.Nullable String countryNameOfficial) {
  ...
  public AstronomyLocation isEu(@javax.annotation.Nullable Boolean isEu) {
    this.isEu = isEu;
    return this;
  }
  ...
  public AstronomyLocation stateProv(@javax.annotation.Nullable String stateProv) {
  ...
  public AstronomyLocation stateCode(@javax.annotation.Nullable String stateCode) {
  ...
  public AstronomyLocation district(@javax.annotation.Nullable String district) {
  ...
  public AstronomyLocation city(@javax.annotation.Nullable String city) {
    this.city = city;
    return this;
  }
  ...
  public AstronomyLocation locality(@javax.annotation.Nullable String locality) {
  ...
  public AstronomyLocation zipcode(@javax.annotation.Nullable String zipcode) {
  ...
  public AstronomyLocation latitude(@javax.annotation.Nullable String latitude) {
  ...
  public AstronomyLocation longitude(@javax.annotation.Nullable String longitude) {
  ...
  public boolean equals(Object o) {
    ...
    AstronomyLocation astronomyLocation = (AstronomyLocation) o;
    return Objects.equals(this.locationString, astronomyLocation.locationString) &&
        Objects.equals(this.continentCode, astronomyLocation.continentCode) &&
        Objects.equals(this.continentName, astronomyLocation.continentName) &&
        Objects.equals(this.countryCode2, astronomyLocation.countryCode2) &&
        Objects.equals(this.countryCode3, astronomyLocation.countryCode3) &&
        Objects.equals(this.countryName, astronomyLocation.countryName) &&
        Objects.equals(this.countryNameOfficial, astronomyLocation.countryNameOfficial) &&
        Objects.equals(this.isEu, astronomyLocation.isEu) &&
        Objects.equals(this.stateProv, astronomyLocation.stateProv) &&
        Objects.equals(this.stateCode, astronomyLocation.stateCode) &&
        Objects.equals(this.district, astronomyLocation.district) &&
        Objects.equals(this.city, astronomyLocation.city) &&
        Objects.equals(this.locality, astronomyLocation.locality) &&
        Objects.equals(this.zipcode, astronomyLocation.zipcode) &&
        Objects.equals(this.latitude, astronomyLocation.latitude) &&
        Objects.equals(this.longitude, astronomyLocation.longitude) &&
        Objects.equals(this.elevation, astronomyLocation.elevation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(locationString, continentCode, continentName, countryCode2, countryCode3, countryName, countryNameOfficial, isEu, stateProv, stateCode, district, city, locality, zipcode, latitude, longitude, elevation);
  }
  ...
  static {
    ...
    ipGeoFields.add("location_string");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AstronomyLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AstronomyLocation.ipGeoRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AstronomyLocation is not found in the empty JSON string", AstronomyLocation.ipGeoRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AstronomyLocation.ipGeoFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AstronomyLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AstronomyLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AstronomyLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AstronomyLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AstronomyLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<AstronomyLocation>() {
           @Override
           public void write(JsonWriter out, AstronomyLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AstronomyLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AstronomyLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AstronomyLocation
   * @throws IOException if the JSON string is invalid with respect to AstronomyLocation
   */
  public static AstronomyLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AstronomyLocation.class);
  }

  /**
   * Convert an instance of AstronomyLocation to an JSON string
   *
   * @return JSON string
   */
