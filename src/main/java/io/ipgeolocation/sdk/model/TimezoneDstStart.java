...
public class TimezoneDstStart {
  ...
  public TimezoneDstStart() {
  }

  public TimezoneDstStart utcTime(@javax.annotation.Nullable String utcTime) {
  ...
  public TimezoneDstStart duration(@javax.annotation.Nullable String duration) {
  ...
  public TimezoneDstStart gap(@javax.annotation.Nullable Boolean gap) {
    this.gap = gap;
    return this;
  }
  ...
  public TimezoneDstStart dateTimeAfter(@javax.annotation.Nullable String dateTimeAfter) {
  ...
  public TimezoneDstStart dateTimeBefore(@javax.annotation.Nullable String dateTimeBefore) {
  ...
  public TimezoneDstStart overlap(@javax.annotation.Nullable Boolean overlap) {
  ...
  public boolean equals(Object o) {
    ...
    TimezoneDstStart timeZoneDstStart = (TimezoneDstStart) o;
    return Objects.equals(this.utcTime, timeZoneDstStart.utcTime) &&
        Objects.equals(this.duration, timeZoneDstStart.duration) &&
        Objects.equals(this.gap, timeZoneDstStart.gap) &&
        Objects.equals(this.dateTimeAfter, timeZoneDstStart.dateTimeAfter) &&
        Objects.equals(this.dateTimeBefore, timeZoneDstStart.dateTimeBefore) &&
        Objects.equals(this.overlap, timeZoneDstStart.overlap);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeZoneDstStart
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimezoneDstStart.ipGeoRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeZoneDstStart is not found in the empty JSON string", TimezoneDstStart.ipGeoRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimezoneDstStart.ipGeoFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeZoneDstStart` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimezoneDstStart.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeZoneDstStart' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimezoneDstStart> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimezoneDstStart.class));

       return (TypeAdapter<T>) new TypeAdapter<TimezoneDstStart>() {
           @Override
           public void write(JsonWriter out, TimezoneDstStart value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimezoneDstStart read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeZoneDstStart given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeZoneDstStart
   * @throws IOException if the JSON string is invalid with respect to TimeZoneDstStart
   */
  public static TimezoneDstStart fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimezoneDstStart.class);
  }

  /**
   * Convert an instance of TimeZoneDstStart to an JSON string
   *
   * @return JSON string
   */
