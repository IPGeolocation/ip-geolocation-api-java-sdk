...
public class ASNResponseXMLAsn {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ASNResponseXMLAsn.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ASNResponseXMLAsn is not found in the empty JSON string", ASNResponseXMLAsn.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ASNResponseXMLAsn.openapiFields.contains(entry.getKey())) {
