...
public class Location {
  ...
  public Location continentCode(@javax.annotation.Nullable String continentCode) {
  ...
  public Location continentName(@javax.annotation.Nullable String continentName) {
  ...
  public Location countryCode2(@javax.annotation.Nullable String countryCode2) {
  ...
  public Location countryCode3(@javax.annotation.Nullable String countryCode3) {
  ...
  public Location countryName(@javax.annotation.Nullable String countryName) {
  ...
  public Location countryNameOfficial(@javax.annotation.Nullable String countryNameOfficial) {
  ...
  public Location countryCapital(@javax.annotation.Nullable String countryCapital) {
  ...
  public Location stateProv(@javax.annotation.Nullable String stateProv) {
  ...
  public Location stateCode(@javax.annotation.Nullable String stateCode) {
  ...
  public Location zipcode(@javax.annotation.Nullable String zipcode) {
  ...
  public Location latitude(@javax.annotation.Nullable String latitude) {
  ...
  public Location longitude(@javax.annotation.Nullable String longitude) {
  ...
  public Location isEu(@javax.annotation.Nullable Boolean isEu) {
    this.isEu = isEu;
    return this;
  }
  ...
  public Location countryFlag(@javax.annotation.Nullable String countryFlag) {
  ...
  public Location geonameId(@javax.annotation.Nullable String geonameId) {
  ...
  public Location countryEmoji(@javax.annotation.Nullable String countryEmoji) {
  ...
  public Location accuracyRadius(@javax.annotation.Nullable String accuracyRadius) {
  ...
  public void setAccuracyRadius(@javax.annotation.Nullable String accuracyRadius) {
    this.accuracyRadius = accuracyRadius;
  }


  public Location locality(@javax.annotation.Nullable String locality) {
  ...
  public Location dmaCode(@javax.annotation.Nullable String dmaCode) {
  ...
  public void setDmaCode(@javax.annotation.Nullable String dmaCode) {
    this.dmaCode = dmaCode;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.continentCode, location.continentCode) &&
        Objects.equals(this.continentName, location.continentName) &&
        Objects.equals(this.countryCode2, location.countryCode2) &&
        Objects.equals(this.countryCode3, location.countryCode3) &&
        Objects.equals(this.countryName, location.countryName) &&
        Objects.equals(this.countryNameOfficial, location.countryNameOfficial) &&
        Objects.equals(this.countryCapital, location.countryCapital) &&
        Objects.equals(this.stateProv, location.stateProv) &&
        ...
        Objects.equals(this.isEu, location.isEu) &&
        Objects.equals(this.countryFlag, location.countryFlag) &&
        Objects.equals(this.geonameId, location.geonameId) &&
        Objects.equals(this.countryEmoji, location.countryEmoji) &&
        Objects.equals(this.accuracyRadius, location.accuracyRadius) &&
        Objects.equals(this.locality, location.locality) &&
        Objects.equals(this.dmaCode, location.dmaCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(continentCode, continentName, countryCode2, countryCode3, countryName, countryNameOfficial, countryCapital, stateProv, stateCode, district, city, zipcode, latitude, longitude, isEu, countryFlag, geonameId, countryEmoji, accuracyRadius, locality, dmaCode);
  }
  ...
  static {
    ...
    ipGeoFields.add("accuracy_radius");
    ipGeoFields.add("locality");
    ipGeoFields.add("dma_code");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Location.ipGeoRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Location is not found in the empty JSON string", Location.ipGeoRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Location.ipGeoFields.contains(entry.getKey())) {
      ...
      if ((jsonObj.get("accuracy_radius") != null && !jsonObj.get("accuracy_radius").isJsonNull()) && !jsonObj.get("accuracy_radius").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `accuracy_radius` to be a primitive type in the JSON string but got `%s`", jsonObj.get("accuracy_radius").toString()));
      }
