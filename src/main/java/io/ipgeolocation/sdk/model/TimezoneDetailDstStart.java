...
public class TimezoneDetailDstStart {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimezoneDetailDstStart.ipGeoRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimezoneDetailDstStart is not found in the empty JSON string", TimezoneDetailDstStart.ipGeoRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimezoneDetailDstStart.ipGeoFields.contains(entry.getKey())) {
