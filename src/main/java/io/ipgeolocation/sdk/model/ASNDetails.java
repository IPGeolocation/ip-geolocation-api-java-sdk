...
public class ASNDetails {
  ...
  public ASNDetails asNumber(@javax.annotation.Nullable String asNumber) {
  ...
  public ASNDetails organization(@javax.annotation.Nullable String organization) {
  ...
  public ASNDetails country(@javax.annotation.Nullable String country) {
  ...
  public ASNDetails asnName(@javax.annotation.Nullable String asnName) {
  ...
  public ASNDetails type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ASNDetails domain(@javax.annotation.Nullable URI domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ASNDetails dateAllocated(@javax.annotation.Nullable String dateAllocated) {
  ...
  public ASNDetails allocationStatus(@javax.annotation.Nullable String allocationStatus) {
  ...
  public ASNDetails numOfIpv4Routes(@javax.annotation.Nullable Integer numOfIpv4Routes) {
  ...
  public ASNDetails numOfIpv6Routes(@javax.annotation.Nullable Integer numOfIpv6Routes) {
  ...
  public ASNDetails rir(@javax.annotation.Nullable String rir) {
    this.rir = rir;
    return this;
  }
  ...
  public ASNDetails routes(@javax.annotation.Nullable List<String> routes) {
    this.routes = routes;
    return this;
  }

  public ASNDetails addRoutesItem(String routesItem) {
    if (this.routes == null) {
  ...
  public ASNDetails upstreams(@javax.annotation.Nullable List<ASNConnection> upstreams) {
    this.upstreams = upstreams;
    return this;
  }

  public ASNDetails addUpstreamsItem(ASNConnection upstreamsItem) {
  ...
  public ASNDetails downstreams(@javax.annotation.Nullable List<ASNConnection> downstreams) {
    this.downstreams = downstreams;
    return this;
  }

  public ASNDetails addDownstreamsItem(ASNConnection downstreamsItem) {
  ...
  public ASNDetails peers(@javax.annotation.Nullable List<ASNConnection> peers) {
    this.peers = peers;
    return this;
  }

  public ASNDetails addPeersItem(ASNConnection peersItem) {
    if (this.peers == null) {
  ...
  public ASNDetails whoisResponse(@javax.annotation.Nullable String whoisResponse) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.asNumber, asNDetails.asNumber) &&
        Objects.equals(this.organization, asNDetails.organization) &&
        Objects.equals(this.country, asNDetails.country) &&
        Objects.equals(this.asnName, asNDetails.asnName) &&
        Objects.equals(this.type, asNDetails.type) &&
        Objects.equals(this.domain, asNDetails.domain) &&
        Objects.equals(this.dateAllocated, asNDetails.dateAllocated) &&
        Objects.equals(this.allocationStatus, asNDetails.allocationStatus) &&
        Objects.equals(this.numOfIpv4Routes, asNDetails.numOfIpv4Routes) &&
        Objects.equals(this.numOfIpv6Routes, asNDetails.numOfIpv6Routes) &&
        Objects.equals(this.rir, asNDetails.rir) &&
        Objects.equals(this.routes, asNDetails.routes) &&
        Objects.equals(this.upstreams, asNDetails.upstreams) &&
        Objects.equals(this.downstreams, asNDetails.downstreams) &&
        Objects.equals(this.peers, asNDetails.peers) &&
        Objects.equals(this.whoisResponse, asNDetails.whoisResponse);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ASNResponseAsn
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ASNDetails.ipGeoRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ASNResponseAsn is not found in the empty JSON string", ASNDetails.ipGeoRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ASNDetails.ipGeoFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ASNResponseAsn` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ASNDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ASNResponseAsn' and its subtypes
       }
  ...
  /**
   * Create an instance of ASNResponseAsn given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ASNResponseAsn
   * @throws IOException if the JSON string is invalid with respect to ASNResponseAsn
   */
  ...
  /**
   * Convert an instance of ASNResponseAsn to an JSON string
   *
   * @return JSON string
   */
