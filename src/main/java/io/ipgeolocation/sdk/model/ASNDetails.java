...
public class ASNDetails {
  ...
  static {
    ...
    openapiFields.add("whois_response");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ASNDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ASNResponseAsn is not found in the empty JSON string", ASNDetails.openapiRequiredFields.toString()));
        }
      }
