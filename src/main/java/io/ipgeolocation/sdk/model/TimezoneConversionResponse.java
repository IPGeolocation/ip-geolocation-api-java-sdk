...
public class TimezoneConversionResponse {
  ...
  static {
    ...
    openapiFields.add("original_time");
    openapiFields.add("converted_time");
    openapiFields.add("diff_hour");
    openapiFields.add("diff_min");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimezoneConversionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeConversionResponse is not found in the empty JSON string", TimezoneConversionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimezoneConversionResponse.openapiFields.contains(entry.getKey())) {
