...
public class TimezoneAirport {
  ...
  static {
    ...
    openapiFields.add("icao_code");
    openapiFields.add("faa_code");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimezoneAirport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimezoneAirport is not found in the empty JSON string", TimezoneAirport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimezoneAirport.openapiFields.contains(entry.getKey())) {
