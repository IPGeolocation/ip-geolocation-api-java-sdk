...
public class UserAgentDataOperatingSystem {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAgentDataOperatingSystem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAgentDataOperatingSystem is not found in the empty JSON string", UserAgentDataOperatingSystem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAgentDataOperatingSystem.openapiFields.contains(entry.getKey())) {
