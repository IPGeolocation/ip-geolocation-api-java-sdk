...
public class TimezoneDetails {
  ...
  static {
    ...
    openapiFields.add("date_time_txt");
    openapiFields.add("date_time_wti");
    openapiFields.add("date_time_ymd");
    openapiFields.add("date_time_unix");
    openapiFields.add("time_24");
    openapiFields.add("time_12");
    openapiFields.add("week");
    openapiFields.add("month");
    openapiFields.add("year");
    openapiFields.add("year_abbr");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimezoneDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimezoneDetail is not found in the empty JSON string", TimezoneDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimezoneDetails.openapiFields.contains(entry.getKey())) {
