...
public class UserAgentXMLDataArray {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAgentXMLDataArray.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAgentXMLDataArray is not found in the empty JSON string", UserAgentXMLDataArray.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAgentXMLDataArray.openapiFields.contains(entry.getKey())) {
