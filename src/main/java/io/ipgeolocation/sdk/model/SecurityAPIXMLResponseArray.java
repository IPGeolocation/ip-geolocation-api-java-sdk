...
public class SecurityAPIXMLResponseArray {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecurityAPIXMLResponseArray.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SecurityAPIXMLResponseArray is not found in the empty JSON string", SecurityAPIXMLResponseArray.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SecurityAPIXMLResponseArray.openapiFields.contains(entry.getKey())) {
